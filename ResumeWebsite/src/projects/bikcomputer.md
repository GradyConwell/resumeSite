...
So, I figured I'd get some time with the ESP32 ecosystem, build my own—one that does exactly what I want, and precisely nothing more.
...
In the meantime, I've gotten marginally better with the ESP32 ecosystem through a handful of other projects that are notable for being finished.
