...
Every applet I've developed previously has been built almost exclusively in JavaScript and HTML. Stitching together my limited Python and Swift skills was a challenge, but I've been careful to follow best practices and keep the architecture modular.
